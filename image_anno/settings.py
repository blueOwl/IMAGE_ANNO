"""
Django settings for image_anno project.
...
SECRET_KEY = 'dz_7p%7fgt4_%4lbh(xnpkcy0&@ro%60%g=bok!biehxutw=)t'
...
WSGI_APPLICATION = 'image_anno.wsgi.application'
